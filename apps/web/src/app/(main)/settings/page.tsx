        ...
        <div className="relative min-h-[80vh] px-6 py-12 overflow-hidden">
            ...
            <div className="mx-auto max-w-2xl relative space-y-8">
                ...
                <div className="space-y-6">
                    {/* Account section */}
                    <section className="glass-panel rounded-xl p-6 border border-text-secondary/10 relative">
                        ...
                        <div className="mb-4 flex items-center justify-between">
                            <h2 className="font-bold text-sm tracking-wide text-text-primary uppercase mono-caps">CREATIVE IDENTITY credentials</h2>
                            <span className="text-[9px] text-vvs-gold mono-caps font-bold">SECURE_VAULT</span>
                        </div>
                        <div className="space-y-4 text-sm">
                            <div className="flex justify-between items-center py-2 border-b border-text-secondary/10">
                                ...
                                <span className="font-mono text-text-primary text-xs">{user?.email || "anonymous@vvs.network"}</span>
                            </div>
                    ...
                    <section className="glass-panel rounded-xl p-6 border border-text-secondary/10 relative">
                        ...
                        <div className="mb-4 flex items-center justify-between">
                            <h2 className="font-bold text-sm tracking-wide text-text-primary uppercase mono-caps">VERIFICATION STATUS</h2>
                    ...
                    <section className="glass-panel rounded-xl p-6 border border-text-secondary/10 relative">
                        ...
                        <div className="mb-4 flex items-center justify-between">
                            <h2 className="font-bold text-sm tracking-wide text-text-primary uppercase mono-caps">FINANCIAL CORAPAY ROUTES</h2>
                    ...
                    <section className="glass-panel rounded-xl p-6 border border-text-secondary/10 relative">
                        ...
                        <div className="mb-4 flex items-center justify-between">
                            <h2 className="font-bold text-sm tracking-wide text-text-primary uppercase mono-caps">PRIVACY & DIRECTORY</h2>
                        ...
                        <div className="space-y-4 text-sm">
                            <div className="flex items-center justify-between py-2 border-b border-text-secondary/10">
                                ...
                                <input type="checkbox" defaultChecked className="rounded border-text-secondary/15 bg-black text-vvs-accent focus:ring-vvs-accent" />
                            </div>
