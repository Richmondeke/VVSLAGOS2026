...
export default function VerifyIdentityPage() {
        ...
        return (
            <div className="relative min-h-[80vh] flex flex-col items-center justify-center px-4 py-12 overflow-hidden">
                ...
                <div className="relative w-full max-w-md text-center space-y-6">
                    <div className="mx-auto w-20 h-20 flex items-center justify-center rounded-full bg-vvs-green/10 border border-vvs-green/30 text-vvs-green text-3xl animate-float">
                        ✓
                    </div>

                    <div className="space-y-2">
                        <span className="mono-caps text-[10px] text-vvs-green font-bold tracking-widest">TRANSMISSION ENCRYPTED</span>
                        <h1 className="text-3xl font-bold tracking-tight mt-1 text-text-primary">DOCUMENT SUBMITTED</h1>
                    ...
                    <div className="glass-panel p-4 rounded-xl border border-text-secondary/10 max-w-xs mx-auto text-left">
                        <div className="text-[9px] text-text-secondary mono-caps">REPUTATION UPDATE</div>
                        <div className="text-sm font-bold text-text-primary mt-1">Pending verification approval</div>
                        <div className="text-[10px] text-vvs-gold font-medium mt-1">⚡ Earned +300 XP (Locked)</div>
                    </div>

                    <a
                        href="/discover"
                        className="inline-block w-full rounded-lg bg-vvs-accent py-3.5 font-bold text-text-primary transition-all duration-200 text-sm tracking-wider"
                    >
    ...
    return (
        <div className="relative min-h-[85vh] flex flex-col items-center justify-center px-4 py-12 overflow-hidden">
            ...
            <div className="absolute bottom-1/4 right-1/4 translate-x-1/2 translate-y-1/2 w-96 h-96 rounded-full bg-vvs-gold/10 blur-[100px] pointer-events-none animate-pulse-glow" style={{ animationDelay: "1s" }} />
            ...
            <div className="relative w-full max-w-lg">
                ...
                <div className="glass-panel rounded-xl p-8 border border-text-secondary/10 relative">
                    {/* Corners */}
                    <div className="absolute top-0 left-0 w-3 h-3 border-t-2 border-l-2 border-text-secondary/20 -translate-x-[1px] -translate-y-[1px]" />
                    <div className="absolute top-0 right-0 w-3 h-3 border-t-2 border-r-2 border-text-secondary/20 translate-x-[1px] -translate-y-[1px]" />
                    <div className="absolute bottom-0 left-0 w-3 h-3 border-b-2 border-l-2 border-text-secondary/20 -translate-x-[1px] translate-y-[1px]" />
                    <div className="absolute bottom-0 right-0 w-3 h-3 border-b-2 border-r-2 border-text-secondary/20 translate-x-[1px] translate-y-[1px]" />

                    <div className="mb-8">
                        <span className="mono-caps text-[10px] text-vvs-accent font-bold tracking-widest">VERIFICATION LAYER</span>
                        <h1 className="text-3xl font-bold tracking-tight mt-1">VERIFY YOUR IDENTITY</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                                        ...
                                        <label
                                            ...
                                            className={`flex cursor-pointer items-center justify-between rounded-xl border p-4 transition-all duration-300 ${
                                                isSelected
                                                    ...
                                                    : "border-text-secondary/10 bg-white/[0.01] hover:border-text-secondary/15 hover:bg-white/[0.02]"
                                            }`}
                                        >
                                            <div className="flex items-center">
                                                <input
                                                    ...
                                                    className="accent-vvs-accent mr-3.5 h-4 w-4"
                                                />
                                                <span className="text-sm font-semibold text-text-primary">{dt.label}</span>
                                            </div>
                        ...
                        <div>
                            ...
                            <div className={`rounded-xl border-2 border-dashed p-8 text-center transition-all duration-300 relative ${
                                file 
                                    ...
                                    : "border-text-secondary/15 bg-white/[0.01] hover:border-text-secondary/20"
                            }`}>
                                <input
                                    type="file"
                                    accept="image/*,.pdf"
                                ...
                                >
                                    {file ? (
                                        ...
                                        <div className="space-y-2">
                                            <div className="text-3xl text-text-primary/30 group-hover:scale-105 transition-transform duration-300">📤</div>
                        ...
                        {status === "uploading" && (
                            <div className="space-y-2">
                                <div className="flex justify-between text-[10px] text-text-secondary mono-caps">
                                    ...
                                    <span className="text-vvs-accent font-bold">{progress}%</span>
                                </div>
                                <div className="h-1.5 overflow-hidden rounded-full bg-text-secondary/5 p-[1px] border border-text-secondary/10">
                                    <div
                                        className="h-full rounded-full bg-vvs-accent transition-all duration-150"
                        ...
                        <button
                            ...
                            className="w-full rounded-lg bg-vvs-accent py-4 font-bold text-text-primary transition-all duration-300 disabled:opacity-30 disabled:pointer-events-none text-sm tracking-wider"
                        >
